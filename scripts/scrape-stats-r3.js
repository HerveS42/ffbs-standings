...
const API_BASE_URL =
  "https://ffbs.wbsc.org/api/v1/stats/events/2026-auvergne-rhone-alpes-championnat-r3-baseball-2026/index";
...
const OUTPUT_PATH = path.join(process.cwd(), "data", "stats-r3.json");
