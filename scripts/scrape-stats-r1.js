...
const API_BASE_URL =
  "https://ffbs.wbsc.org/api/v1/stats/events/2026-auvergne-rhone-alpes-championnat-r1-baseball/index";
...
const OUTPUT_PATH = path.join(process.cwd(), "data", "stats-r1.json");
