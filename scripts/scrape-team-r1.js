...
const SOURCE_URL =
  "https://ffbs.wbsc.org/fr/events/2026-auvergne-rhone-alpes-championnat-r1-baseball/teams/41375";

const ROSTER_OUTPUT_PATH = path.join(process.cwd(), "data", "roster-r1.json");
const RESULTS_OUTPUT_PATH = path.join(process.cwd(), "data", "results-r1.json");
...
async function saveDebugFile(html) {
  ...
  await writeFile("debug/team-page-r1.html", html, "utf-8");
}
